...
bun src/cli/index.js convert extensions/web-search-navigator -o examples/web-search-navigator.user.js --force --beautify
...
bun src/cli/index.js convert extensions/ublacklist -o examples/ublacklist.user.js --force --minify
