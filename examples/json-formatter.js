...
(function () {
  ...
  // #region Orchestration Logic
	  ...
	  const INJECTED_MANIFEST = {
	    ...
	    page_action: {},
	    action: {},
	    icons: { 32: "icons/32.png", 128: "icons/128.png" },
	  ...
	  const EXTENSION_ICON =
	    "data:image/png;base64,";
  ...
  // #endregion
    // #region Document End
			      ...
			      try {
			        ...
			        with (globalThis) {
			          ...
			          (() => {
			            ...
			            var M = "Runtime assertion failed";
			            function f(e, l) {
			              if (e) return;
			              let i = typeof l == "function" ? l() : l,
			                n = i ? "".concat(M, ": ").concat(i) : M;
			              throw new Error(n);
			            }
			            var O = (e) =>
			              typeof e == "string"
			            ...
			            var J = document.createElement("span"),
			              ...
			              m = (e) => {
			                let l = _();
			                return (l.className = e), l;
			              },
			              h = (e, l) => {
			                let i = _();
			                return (i.className = l), (i.innerText = e), i;
			              },
			              s = {
			                t_entry: m("entry"),
			                t_exp: m("e"),
			                ...
			                t_oBracket: h("[", "b"),
			                t_cBracket: h("]", "b"),
			                t_sizeComment: m("sizeComment"),
			                t_ellipsis: m("ell"),
			                t_blockInner: m("blockInner"),
			            ...
			            var k = (e, l) => {
			              let i = O(e),
			                n = s.t_entry.cloneNode(!1),
			                d = 0;
			              i === 3 ? (d = Object.keys(e).length) : i === 4 && (d = e.length);
			              let b = !1;
			              if (i === 3 || i === 4) {
			                for (let t in e)
			                ...
			                b && n.appendChild(s.t_exp.cloneNode(!1));
			              }
			              if (l !== !1) {
			                n.classList.add("objProp");
			                let t = s.t_key.cloneNode(!1);
			                (t.textContent = JSON.stringify(l).slice(1, -1)),
			                  n.appendChild(s.t_dblqText.cloneNode(!1)),
			                  n.appendChild(t),
			                  n.appendChild(s.t_dblqText.cloneNode(!1)),
			                  n.appendChild(s.t_colonAndSpace.cloneNode(!1));
			              } else n.classList.add("arrElem");
			              let p, c;
			              switch (i) {
			                case 1: {
			                  f(typeof e == "string");
			                  ...
			                  if (
			                    ...
			                    (a.href = e), (a.innerText = o), t.appendChild(a);
			                  } else t.innerText = o;
			                  let r = s.t_string.cloneNode(!1);
			                  r.appendChild(s.t_dblqText.cloneNode(!1)),
			                    r.appendChild(t),
			                    r.appendChild(s.t_dblqText.cloneNode(!1)),
			                    n.appendChild(r);
			                  break;
			                ...
			                case 2: {
			                  let t = s.t_number.cloneNode(!1);
			                  (t.innerText = String(e)), n.appendChild(t);
			                  break;
			                }
			                case 3: {
			                  if (
			                    (f(typeof e == "object"),
			                    n.appendChild(s.t_oBrace.cloneNode(!0)),
			                    b)
			                  ) {
			                    n.appendChild(s.t_ellipsis.cloneNode(!1)),
			                      (p = s.t_blockInner.cloneNode(!1));
			                    let t;
			                    for (let o in e)
			                      if (e.hasOwnProperty(o)) {
			                        c = k(e[o], o);
			                        let r = s.t_commaText.cloneNode();
			                        c.appendChild(r), p.appendChild(c), (t = r);
			                      }
			                    f(typeof c < "u" && typeof t < "u"),
			                      c.removeChild(t),
			                      n.appendChild(p);
			                  }
			                  n.appendChild(s.t_cBrace.cloneNode(!0)),
			                    (n.dataset.size = ` // ${d} ${d === 1 ? "item" : "items"}`);
			                  break;
			                }
			                case 4: {
			                  if (
			                    (f(Array.isArray(e)),
			                    n.appendChild(s.t_oBracket.cloneNode(!0)),
			                    b)
			                  ) {
			                    n.appendChild(s.t_ellipsis.cloneNode(!1)),
			                      (p = s.t_blockInner.cloneNode(!1));
			                    for (let t = 0, o = e.length, r = o - 1; t < o; t++) {
			                      if (((c = k(e[t], !1)), t < r)) {
			                        let a = s.t_commaText.cloneNode();
			                        c.appendChild(a);
			                      }
			                      p.appendChild(c);
			                    }
			                  ...
			                  n.appendChild(s.t_cBracket.cloneNode(!0)),
			                    (n.dataset.size = ` // ${d} ${d === 1 ? "item" : "items"}`);
			                  break;
			                }
			                case 5: {
			                  e
			                    ? n.appendChild(s.t_true.cloneNode(!0))
			                    : n.appendChild(s.t_false.cloneNode(!0));
			                  break;
			                }
			                case 6: {
			                  n.appendChild(s.t_null.cloneNode(!0));
			                  break;
			                }
			              }
			              return n;
			...
			`,
			              R = !1,
			              Y = new Promise((e) => {
			                chrome.storage.local.get("themeOverride", (l) => {
			                  switch (l.themeOverride) {
			                    case "force_light":
			                      e(L);
			                      break;
			                    case "force_dark":
			...
			` +
			              ...
			              j = (async () => {
			                let e = (() => {
			                  let t = document.body.children,
			                    o = t.length;
			                  for (let r = 0; r < o; r++) {
			                    let a = t[r];
			                    if (a.tagName === "PRE") return a;
			                  }
			                  return null;
			                })();
			                if (e === null)
			                ...
			                if (!l)
			                  return {
			                    formatted: !1,
			                    note: "No content in body>pre",
			                    rawLength: 0,
			                  };
			                let i = l.length;
			                if (i > 3e6)
			                  return { formatted: !1, note: "Too long", rawLength: i };
			                if (!/^\s*[\{\[]/.test(l))
			                  return {
			                    formatted: !1,
			                ...
			                (n.id = "jsonFormatterParsed"), document.body.appendChild(n);
			                let d = document.createElement("div");
			                (d.hidden = !0),
			                  (d.id = "jsonFormatterRaw"),
			                  d.append(e),
			                  document.body.appendChild(d);
			                {
			                  ...
			                  let o = t;
			                  {
			                    ...
			                    (a.id = "jfStyleEl"),
			                      a.insertAdjacentHTML("beforeend", await Y),
			                  ...
			                  let r = k(o, !1);
			                  await Promise.resolve(), n.append(r);
			                }
			                for (let t of document.getElementsByClassName(
			                  "json-formatter-container",
			                ))
			                  t.style.display = "none";
			                return { formatted: !0, note: "done", rawLength: i };
			                function b(t) {
			                  let o, r, a;
			                  for (r = t.length - 1; r >= 0; r--)
			                    if (((o = t[r]), o.classList.add("collapsed"), !o.id)) {
			                      for (
			                        a = o.firstElementChild;
			                        a && !a.classList.contains("blockInner");
			                ...
			                function p(t) {
			                  for (let o = t.length - 1; o >= 0; o--)
			                    t[o].classList.remove("collapsed");
			                }
			                function c(t) {
			                  let o = t.target;
			                  if (o instanceof HTMLElement && o.className === "e") {
			                    t.preventDefault();
			                    let r = o.parentNode;
			                    if (
			                      ...
			                      if (t.metaKey || t.ctrlKey) {
			                        let a = r.parentNode;
			                        f(a instanceof HTMLElement), p(a.children);
			                      } else p([r]);
			                    else if (t.metaKey || t.ctrlKey) {
			                      let a = r.parentNode;
			                      f(a instanceof HTMLElement), b(a.children);
			                    } else b([r]);
			                  }
			                }
			              })();
			            R &&
			              j.then((e) => {
			                let l = window.__jsonFormatterStartTime,
			                  n = performance.now() - l;
			                console.log("JSON Formatter", e),
			                  console.log("Duration:", Math.round(n * 10) / 10, "ms");
			              });
			          })();
			          // END: content.js
			        }
