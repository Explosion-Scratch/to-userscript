    ...
    try {
      void 0 !== window.isSecureContext &&
        ...
        trustedTypes.defaultPolicy
          ? (d("TT Default Policy exists"),
            (c = window.trustedTypes.createPolicy("default", c)),
            (o = trustedTypes.defaultPolicy),
            d(
              `Created custom passthrough policy, in case the default policy is too restrictive: Use Policy '${s}' in var 'TTP':`,
              c
            ))
          : (o = c = window.trustedTypes.createPolicy("default", c)),
        d("Trusted-Type Policies: TTP:", c, "TTP_default:", o));
    } catch (e) {
      d(e);
    }
  },
...
(function () {
  ...
  function createRuntime(type = "background", bus) {
    ...
    function makePort(side, portId, name, remoteWindow) {
      ...
      function _receive(envelope, source) {
        ...
        onMessageHandlers.forEach((fn) => fn(envelope.msg, { id: portId, tab: { id: source } }));
      }
  ...
  (function () {
    ...
    console.log("[PostMessage Handler] Abstraction layer message handler initialized");
  })();
  ...
  async function _storageGet(keys) {
    ...
    if (Array.isArray(keys) && (keys.length === 0 || [null, undefined].includes(keys[0]))) {
      keys = null;
    }
    try {
      const results = {};
          ...
          onload: function (response) {
            ...
            const mockResponse = {
              ...
              arrayBuffer: () => {
                ...
                return Promise.reject(
                  new Error("Requires responseType:'arraybuffer' in GM_xmlhttpRequest")
                );
              },
              clone: function () {
                const cloned = { ...this };
  ...
  function buildPolyfill({ isBackground = false, isOtherPage = false } = {}) {
    ...
    const contextType = isBackground ? "background" : isOtherPage ? "options" : "content";
    ...
    const BUS = (function () {
      ...
      globalThis.__BUS = createEventBus("web-search-navigator", IS_IFRAME ? "iframe" : "page");
      return globalThis.__BUS;
    })();
    ...
    let chrome = {
      ...
      runtime: {
        ...
        getManifest: () => {
          ...
          console.warn("INJECTED_MANIFEST not found for chrome.runtime.getManifest");
      ...
      storage: {
        local: {
          get: function (keys, callback) {
            if (typeof _storageGet !== "function") throw new Error("_storageGet not defined");
          ...
          set: function (items, callback) {
            if (typeof _storageSet !== "function") throw new Error("_storageSet not defined");
          ...
          remove: function (keys, callback) {
            if (typeof _storageRemove !== "function") throw new Error("_storageRemove not defined");
          ...
          clear: function (callback) {
            if (typeof _storageClear !== "function") throw new Error("_storageClear not defined");
      ...
      cookies: (function () {
        ...
        return {
          ...
          set: function (details, callback) {
            const promise = (async () => {
              if (typeof _cookieSet !== "function" || typeof _cookieList !== "function") {
          ...
          remove: function (details, callback) {
            const promise = (async () => {
              if (typeof _cookieDelete !== "function" || typeof _cookieList !== "function") {
          ...
          getPartitionKey: function (details, callback) {
            console.warn("chrome.cookies.getPartitionKey is not supported in this environment.");
      ...
      tabs: {
        query: async (queryInfo) => {
          console.warn("chrome.tabs.query polyfill only returns current tab info.");
    ...
    const loggingProxyHandler = (_key) => ({
      get(target, key, receiver) {
        tc(() => console.log(`[${contextType}] [CHROME - ${_key}] Getting ${key}`));
        return Reflect.get(target, key, receiver);
      },
      set(target, key, value, receiver) {
        tc(() => console.log(`[${contextType}] [CHROME - ${_key}] Setting ${key} to ${value}`));
        return Reflect.set(target, key, value, receiver);
      },
      has(target, key) {
        tc(() => console.log(`[${contextType}] [CHROME - ${_key}] Checking if ${key} exists`));
      ...
      defineProperty(target, key, descriptor) {
        try {
          ...
          if (hasAccessor) {
            ...
            const normalized = {
              configurable: "configurable" in descriptor ? descriptor.configurable : true,
  ...
  const START_BACKGROUND_SCRIPT = function () {
    ...
    const scriptName = "Web Search Navigator";
  ...
  const INJECTED_MANIFEST = {
    ...
    background: {
      scripts: ["browser-polyfill.js", "webext-dynamic-content-scripts.js", "background.js"],
      persistent: false,
    },
  ...
  const convertMatchPatternToRegExp = function convertMatchPatternToRegExp(pattern) {
    ...
    try {
      const singleEscapedPattern = convertMatchPatternToRegExpString(pattern).replace(
        /\\\\/g,
        "\\"
      );
  ...
  const convertMatchPatternToRegExpString = function convertMatchPatternToRegExpString(pattern) {
    ...
    let hostRegex;
    if (host === "*") hostRegex = "[^/]+";
    else if (host.startsWith("*.")) hostRegex = "(?:[^\\/]+\\.)?" + escapeRegex(host.substring(2));
      ...
      try {
        ...
        with (globalThis) {
          ...
          !(function (e, t, n) {
              ...
              return (
                n ||
                  (n = (function () {
                    if (!r)
                      for (var e in ((r = {}), o))
                        (e > 95 && e < 112) || (o.hasOwnProperty(e) && (r[o[e]] = e));
                    return r;
                  })()[e]
                    ? "keydown"
                    : "keypress"),
            ...
            function y(e) {
              ...
              function p(e, t, r, a, i, c) {
                ...
                for ("keyup" == d && f(e) && (t = [e]), u = 0; u < n._callbacks[e].length; ++u)
                  if (
                    ((l = n._callbacks[e][u]),
                    (a || !l.seq || o[l.seq] == l.level) &&
                      d == l.action &&
                      (("keypress" == d && !r.metaKey && !r.ctrlKey) ||
                        ((s = t), (p = l.modifiers), s.sort().join(",") === p.sort().join(","))))
                  ) {
                    var y = !a && l.combo == i,
              ...
              (n._handleKey = function (e, t, n) {
                ...
                for (r = 0; r < o.length; ++r)
                  if (o[r].seq) {
                    ...
                    (s = !0), (a[o[r].seq] = 1), d(o[r].callback, n, o[r].combo, o[r].seq);
                  } else s || d(o[r].callback, n, o[r].combo);
                var h = "keypress" == n.type && i;
                n.type != c || f(e) || h || u(a), (i = s && "keydown" == n.type);
              }),
          ...
          !(function (t) {
            if (t) {
              ...
              (t.prototype.stopCallback = function (t, n, e, a) {
                return !!this.paused || (!o[e] && !o[a] && i.call(this, t, n, e));
              }),
          ...
          class GoogleSearch {
            ...
            static #cardResults() {
              ...
              return [
                ...
                {
                  nodes: document.querySelectorAll("#search [data-init-vis=true] [role=heading]"),
                ...
                {
                  nodes: document.querySelectorAll("#search video-voyager a [role=heading]"),
                  anchorSelector: nearestChildOrSiblingOrParentAnchor,
            ...
            static #memexResults() {
              return [
                {
                  nodes: document.querySelectorAll("#memexResults ._3d3zwUrsb4CVi1Li4H6CBw a"),
            ...
            static #imageSearchTabs() {
              ...
              return {
                ...
                navigateMapsTab: selectorElementGetter('.T47uwc > a[href*="maps.google."]'),
                navigateVideosTab: selectorElementGetter('.T47uwc > a[href*="&tbm=vid"]'),
                navigateNewsTab: selectorElementGetter('.T47uwc > a[href*="&tbm=nws"]'),
                navigateShoppingTab: selectorElementGetter('a[role="menuitem"][href*="&tbm=shop"]'),
                navigateBooksTab: selectorElementGetter('a[role="menuitem"][href*="&tbm=bks"]'),
                navigateFlightsTab: selectorElementGetter('a[role="menuitem"][href*="&tbm=flm"]'),
            ...
            changeTools(period) {
              ...
              if (period === "a") {
                ...
                searchParams.set("tbs", `${currentPeriod}` + (currentSort ? "" : ",sbd:1"));
              }
          ...
          class BraveSearch {
            ...
            getTopMargin(element) {
              return getFixedSearchBoxTopMargin(document.querySelector("header.navbar"), element);
            }
            ...
            get tabs() {
              return {
                ...
                navigateImagesTab: document.querySelector("#tab-images > a:first-of-type"),
                navigateNewsTab: document.querySelector('a[href*="/news?q="]'),
                navigateVideosTab: document.querySelector("#tab-videos > a:first-of-type"),
              };
            }
          }
          ...
          class YouTube {
            ...
            onChangedResults(callback) {
              ...
              const pageObserver = new MutationObserver(debounce(pageObserverCallback, 50));
            ...
            getSearchResults() {
              const includedElements = [
                ...
                {
                  nodes: document.querySelectorAll('ytd-playlist-renderer a[href*="/playlist"]'),
                  highlightClass: "wsn-youtube-focused-video",
                ...
                // Playlists
                {
                  ...
                  highlightClass: "wsn-youtube-focused-video",
                  highlightedElementSelector: (n) => n.closest("ytd-playlist-video-renderer"),
              ...
              const homePageElements = {
                nodes: document.querySelectorAll("ytd-rich-item-renderer a#video-title-link"),
                highlightClass: "wsn-youtube-focused-video",
                highlightedElementSelector: (n) => n.closest("ytd-rich-item-renderer"),
                containerSelector: (n) => n.closest("ytd-rich-item-renderer"),
              };
              const results = getSortedSearchResults([...includedElements, homePageElements], []);
              ...
              if (isHomePage && gridRow != null) {
                results.itemsPerRow = gridRow.getElementsByTagName("ytd-rich-item-renderer").length;
          ...
          class GoogleScholar {
            ...
            getSearchResults() {
              const includedElements = [
                ...
                {
                  nodes: document.querySelectorAll(".gs_ico_nav_previous, .gs_ico_nav_next"),
          ...
          class Amazon {
            ...
            getSearchResults() {
              const includedElements = [
                ...
                // more general.
                {
                  nodes: document.querySelectorAll(".s-main-slot h2 .a-link-normal.a-text-normal"),
                  // highlightedElementSelector: (n) => n.parentElement.children[1],
          ...
          class Github {
            ...
            static #getCommitSearchLinks() {
              ...
              for (const con of commitsContainers) {
                ...
                if (links.length === 1) {
                  ...
                  const prLink = con.querySelector('a[data-hovercard-type="pull_request"]');
                  if (prLink != null) {
                    commits.push(prLink);
                  }
                }
            ...
            getSearchResults() {
              const includedElements = [
                ...
                // Issues
                {
                  nodes: document.querySelectorAll("#issue_search_results .text-normal a"),
                  highlightClass: "wsn-github-focused-item",
                },
                // Marketplace
                {
                  nodes: document.querySelectorAll("#marketplace_search_results .text-normal a"),
                  highlightClass: "wsn-github-focused-item",
                },
                // Topics
                {
                  nodes: document.querySelectorAll("#topic_search_results .text-normal a"),
                  highlightClass: "wsn-github-focused-item",
                },
                // Wikis
                {
                ...
                {
                  nodes: document.querySelectorAll(".pinned-item-list-item-content span.repo"),
                  highlightClass: "wsn-github-focused-item",
          ...
          class Gitlab {
            ...
            getSearchResults() {
              const includedElements = [
                ...
                {
                  nodes: document.querySelectorAll("ul.groups-list li.group-row a[aria-label]"),
          ...
          class SearchResultsManager {
            ...
            highlight(searchResult) {
              ...
              if (this.options.sync.get("hideOutline") || searchResult.anchor !== highlighted) {
            ...
            focusDown(shouldWrap) {
              if (this.focusedIndex + this.searchResults.itemsPerRow < this.searchResults.length) {
            ...
            focusUp(shouldWrap) {
              if (this.focusedIndex - this.searchResults.itemsPerRow >= 0) {
                ...
                const focusedRowIndex = this.focusedIndex % this.searchResults.itemsPerRow;
                this.focus(
                  this.searchResults - 1 - this.searchResults.itemsPerRow + focusedRowIndex
                );
              } else {
          ...
          class WebSearchNavigator {
            ...
            initSearchInputNavigation() {
              let searchInput = document.querySelector(this.searchEngine.searchBoxSelector);
              if (searchInput == null) {
                return;
              }
              ...
              this.register(this.options.sync.get("focusSearchInput"), outsideSearchboxHandler);
            ...
            resetResultsManager() {
              ...
              this.resultsManager = new SearchResultsManager(this.searchEngine, this.options);
              this.resultsManager.reloadSearchResults();
            }
            ...
            registerResultsNavigationKeybindings(gridNavigation) {
              ...
              if (!gridNavigation) {
                this.register(getOpt("nextKey"), onFocusChange(this.resultsManager.focusNext));
                this.register(
                  getOpt("previousKey"),
                  onFocusChange(this.resultsManager.focusPrevious)
                );
              } else {
                this.register(getOpt("nextKey"), onFocusChange(this.resultsManager.focusDown));
                this.register(getOpt("previousKey"), onFocusChange(this.resultsManager.focusUp));
                // Left
                this.register(
              ...
              this.register(getOpt("navigateNewTabBackgroundKey"), () => {
                ...
                if (getOpt("simulateMiddleClick")) {
                  ...
                  const middleClickMousedown = new MouseEvent("mousedown", mouseEventParams);
            ...
            initChangeToolsNavigation() {
              ...
              this.register(getOpt("navigateShowAll"), () => this.searchEngine.changeTools("a"));
              this.register(getOpt("navigateShowHour"), () => this.searchEngine.changeTools("h"));
              this.register(getOpt("navigateShowDay"), () => this.searchEngine.changeTools("d"));
              this.register(getOpt("navigateShowWeek"), () => this.searchEngine.changeTools("w"));
              this.register(getOpt("navigateShowMonth"), () => this.searchEngine.changeTools("m"));
              this.register(getOpt("navigateShowYear"), () => this.searchEngine.changeTools("y"));
              this.register(getOpt("toggleVerbatimSearch"), () =>
                this.searchEngine.changeTools("v")
              );
              this.register(getOpt("toggleSort"), () => this.searchEngine.changeTools(null));
              ...
              this.register(getOpt("showImagesIcon"), () => this.searchEngine.changeImageSize("i"));
            }
