...
(function () {
  ...
  // #region Orchestration Logic
	  ...
	  const EXTENSION_ICON =
	    "data:image/png;base64,";
	  ...
	  const LOCALE_KEYS = {
	    locale_id: { message: "English (US)" },
	    page_title: { message: "Iridium" },
	  };
  ...
  // #region Script Execution Logic
		  async function executeAllScripts(globalThis, extensionCssData) {
		    ...
		    const scriptName = "Iridium for YouTube"; // Make name available inside
			    ...
			    if (typeof document !== "undefined") {
			      ...
			      try {
			        if (extensionCssData[cssKey_0]) {
			          ...
			          console.warn(`  CSS not found (start): ${cssKey_0}`);
			        }
			      } catch (e) {
			        console.error(
			          `  Failed injecting CSS (${cssKey_0}) in phase start`,
			          e,
			          extensionCssData,
			        );
			      }
			      ...
			      try {
			        ...
			        with (globalThis) {
			          ...
			          const getDefaultSettings = () =>
			            Object.keys(SettingData).reduce(
			          ...
			          function mainScript(extensionId, SettingData, defaultSettings) {
			            ...
			            const OverrideHandleResponse = (() => {
			              ...
			              return {
			                onHandleResponseListener: (listener) =>
			            ...
			            const OverrideFetch = (() => {
			              ...
			              const canProceed = (data) => {
			                ...
			                if (
			                  ...
			                  for (let i = endpoints.length - 1; i >= 0; i--) {
			                    if (
			                      endpoints[i]?.["reloadContinuationItemsCommand"]?.[
			                        "targetId"
			                      ] === "comments-section"
			                    ) {
			                      return false;
			              ...
			              const override = function (target, thisArg, argArray) {
			                if (
			                  !argArray?.[0]?.url ||
			                  Object.getOwnPropertyDescriptor(argArray[0], "url") !==
			                    undefined
			                ) {
			            ...
			            const OverrideVideoPlay = (() => {
			              ...
			              const onClick = (event) => {
			                ...
			                canPlay =
			                  ...
			                  (document
			                    ...
			                    document
			                      .querySelector(c4PlayerContainers)
			                      ?.contains(event.target) === true);
			              ...
			              const isAllowed = (target) => {
			                ...
			                const isC4Player =
			                  document.getElementById("c4-player")?.contains(target) ===
			                  true;
			              ...
			              FeatureUpdater.register(
			                SettingData.autoplayChannelTrailer.id,
			                update,
			              );
			              ...
			              const listener = (data) => {
			                ...
			                topBarButtons.forEach(function (value) {
			                  if (
			                    ...
			                    value.topbarMenuButtonRenderer.icon.iconType ===
			                      "IRIDIUM_LOGO"
			                  ) {
			            ...
			            const FeatureDefaultTab = (() => {
			              const iniDefaultTab = (event) => {
			                ...
			                if (url) {
			                  metadata.url =
			                    link.href = `${url}/${iridiumSettings.channelTab}`;
			                }
			              };
			            ...
			            const FeaturePlaylistReverse = (() => {
			              ...
			              const reversePlaylist = (data) => {
			                ...
			                const topLevelButtons =
			                  playlist?.["playlistButtons"]?.["menuRenderer"]?.[
			                    "topLevelButtons"
			                  ];
			                ...
			                if (autoplaySets?.constructor === Array) {
			                  for (let i = 0; i < autoplaySets.length; i++) {
			                    ...
			                    if (
			                      item["previousButtonVideo"] &&
			                      item["nextButtonVideo"]
			                    ) {
			                ...
			                if (contents?.constructor === Array) {
			                  ...
			                  for (let i = 0; i < count; i++) {
			                    ...
			                    if (
			                      item?.["playlistPanelVideoRenderer"]?.["indexText"]?.[
			                        "simpleText"
			                      ]
			                    ) {
			                      item["playlistPanelVideoRenderer"]["indexText"][
			              ...
			              const listener = (data) => {
			                ...
			                for (let i = 0; i < length; i++) {
			                  if (
			                    topLevelButtons[i]?.["toggleButtonRenderer"]?.id ===
			                    "reversePlaylist"
			                  ) {
			                  ...
			                  if (
			                    i === length - 1 &&
			                    iridiumSettings.reversePlaylist === true
			                  ) {
			              ...
			              const updateUI = (data) => {
			                ...
			                const ytPlaylistManager = document.querySelector(
			                  "yt-playlist-manager",
			                );
			              ...
			              const onDocumentClick = (event) => {
			                ...
			                if (isReverseButton && ytdWatchData) {
			                  iridiumSettings.reversePlaylistToggled =
			                    !iridiumSettings.reversePlaylistToggled;
			                  Broadcaster.saveSetting(
			                    SettingData.reversePlaylistToggled.id,
			                  );
			            ...
			            const FeatureSuperTheater = (() => {
			              const onResize = () => {
			                ...
			                if (
			                  ...
			                  if (
			                    chat &&
			                    !chat.firstElementChild.hasAttribute("collapsed")
			                  ) {
			                  ...
			                  if (chat && document.getElementById("full-bleed-container")) {
			                    ...
			                    if (sidebar && !sidebar.contains(chat)) {
			                      const donationShelf =
			                        document.getElementById("donation-shelf");
			
			                      if (
			                        donationShelf &&
			                        sidebar === donationShelf.parentElement
			                      ) {
			            ...
			            const FeatureSuperTheaterScrollbar = (() => {
			              ...
			              FeatureUpdater.register(
			                SettingData.superTheaterScrollbar.id,
			                update,
			              );
			            ...
			            const FeatureAlwaysVisible = (() => {
			              ...
			              const updatePosition = () => {
			                ...
			                const newX = (iridiumSettings.alwaysVisiblePosition.x ??=
			                  offset);
			                const newY = (iridiumSettings.alwaysVisiblePosition.y ??=
			                  offset);
			                const snapRight =
			              ...
			              const updateState = (event) => {
			                ...
			                const parentRects =
			                  moviePlayer?.parentElement?.getBoundingClientRect();
			            ...
			            const FeaturePlayerTools = (() => {
			              const getPlayerTools = () => {
			                ...
			                let playerTools = document.getElementById(
			                  "iridium-player-tools",
			                );
			              ...
			              const checkPlayerToolsSpacing = (playerTools) => {
			                ...
			                if (titleSection) {
			                  titleSection.style.paddingRight =
			                    (playerTools.offsetWidth || 0) + "px";
			                }
			              };
			            ...
			            const FeatureVideoFocus = (() => {
			              ...
			              const check = (playerTools) => {
			                if (!iridiumSettings.videoFocusToggle) {
			                  ...
			                  let videoFocusButton =
			                    document.getElementById("iridium-focus");
			              ...
			              const update = (playerTools) => {
			                if (!iridiumSettings.videoScreenshot) {
			                  ...
			                  let screenshotButton =
			                    document.getElementById("iridium-screenshot");
			            ...
			            const FeatureThumbnail = (() => {
			              const update = (playerTools) => {
			                if (!iridiumSettings.videoThumbnail) {
			                  ...
			                  let thumbnailButton =
			                    document.getElementById("iridium-thumbnail");
			              ...
			              const getData = (data) => {
			                if (data.constructor === Object) {
			                  if (data["videoDetails"]) {
			                    ...
			                    return Util.getSingleObjectByKey(
			                      data,
			                      "raw_player_response",
			                    );
			                  }
			                  ...
			                  if (monetizationButton) {
			                    ...
			                    if (stored.adCount > 0) {
			                      ...
			                      document
			                        ...
			                        ?.replaceChildren(
			                          document.createTextNode(stored.adCount),
			                        );
			                    } else {
			            ...
			            const FeatureAutoplayShortcut = (() => {
			              ...
			              const check = (playerTools) => {
			                if (!iridiumSettings.autoplayShortcut) {
			                  document
			                    .getElementById("iridium-autoplay-shortcut")
			                    ?.remove();
			                } else if (playerTools) {
			            ...
			            const FeatureDefaultQuality = (() => {
			              ...
			              const getClosestAvailableQuality = (quality, availableList) => {
			                ...
			                for (let i = 0; i < total; i++) {
			                  ...
			                  const bottomIndex = availableList.indexOf(
			                    qualityList[bottom],
			                  );
			              ...
			              const onCreated = (api) =>
			                api.addEventListener("onStateChange", () => {
			                  if (
			                    ...
			                    const currentSpeed =
			                      api?.["getPlaybackRate"]?.()?.toString();
			
			                    if (
			                      iridiumSettings.defaultSpeed !== currentSpeed &&
			                      currentId !== videoId
			                    ) {
			                      const availableSpeedList =
			            ...
			            const FeatureAdManager = (() => {
			              ...
			              const checkHomePageAds = (itemContainer) => {
			                for (let i = itemContainer.length - 1; i >= 0; i--) {
			                  ...
			                  const exists =
			                    itemRenderer?.["richItemRenderer"]?.["content"]?.[
			                      "adSlotRenderer"
			                    ] ||
			              ...
			              const listener = (data) => {
			                ...
			                if (!isAdTaggedProductsAllowed) {
			                  ...
			                  if (
			                    playerOverlayRenderer?.["productsInVideoOverlayRenderer"]
			                  ) {
			                    delete playerOverlayRenderer[
			                ...
			                if (!isAdSearchFeedAllowed) {
			                  ...
			                  if (
			                    ...
			                    for (
			                      let i = sectionListRendererContents.length - 1;
			                      i >= 0;
			                      i--
			                    ) {
			                      ...
			                      if (
			                        ...
			                        for (
			                          let j = itemRendererContents.length - 1;
			                          j >= 0;
			                          j--
			                        ) {
			              ...
			              const listener = (data) => {
			                if (!iridiumSettings.searchShorts) {
			                  ...
			                  const listContents =
			                    ...
			                    Util.getSingleObjectByKey(
			                      data,
			                      "appendContinuationItemsAction",
			                    )?.["continuationItems"];
			
			                  if (
			                    listContents?.constructor === Array &&
			                        ...
			                        for (
			                          ...
			                          if (
			                            ...
			                            if (
			                              ...
			                              for (
			                                let k = shelfRendererItems.length - 1;
			                                k >= 0;
			                                k--
			                              ) {
			                ...
			                if (
			                  ...
			                  const richGridRendererContents =
			                  ...
			                  if (
			                    ...
			                    for (
			                      let i = richGridRendererContents.length - 1;
			                      i >= 0;
			                      i--
			                    ) {
			                      ...
			                      if (
			                        ...
			                        for (
			                          let j = richShelfRendererContents.length - 1;
			                          j >= 0;
			                          j--
			                        ) {
			                          const richItemRendererContent =
			                            richShelfRendererContents[j]?.[
			                              "richItemRenderer"
			                            ]?.["content"];
			              ...
			              const onVideoCountData = (pageData, subCount, profileCounts) => {
			                ...
			                if (subCount["textChanged_"]) {
			                  subCount["textChanged_"]?.({
			                    runs: [{ text: profileCounts }],
			                  });
			                } else if (
			                  subCount.textContent === subCount["text"]["simpleText"]
			                ) {
			            ...
			            const FeatureLoudness = (() => {
			              const listener = (data) => {
			                if (!iridiumSettings.loudness) {
			                  const audioConfig = Util.getSingleObjectByKey(
			                    data,
			                    "audioConfig",
			                  );
			            ...
			            const FeatureScrollVolume = (() => {
			              const iniScrollVolume = (event) => {
			                ...
			                let levelText = document.getElementById(
			                  "iridium-scroll-volume-level",
			                );
			              ...
			              const update = () => {
			                if (iridiumSettings.scrollVolume) {
			                  document.addEventListener("wheel", iniScrollVolume, {
			                    passive: false,
			                  });
			                } else {
			            ...
			            const FeatureBlacklist = (() => {
			              ...
			              const removeItems = (data) => {
			                ...
			                if (richGridPages.indexOf(window.location.pathname) > -1) {
			                  ...
			                  if (
			                    ...
			                    for (let i = itemContainer.length - 1; i >= 0; i--) {
			                      const richShelfRendererContents =
			                        itemContainer[i]?.["richSectionRenderer"]?.[
			                          "content"
			                        ]?.["richShelfRenderer"]?.["contents"];
			                  ...
			                  const endScreenRendererResults =
			                    endScreenRenderer?.["results"];
			                  ...
			                  if (
			                    ...
			                    for (
			                      let i = endScreenRendererResults.length - 1;
			                      i >= 0;
			                      i--
			                    ) {
			                      const browseId =
			                        endScreenRendererResults[i]?.[
			                  ...
			                  sectionListPages.indexOf(window.location.pathname) > -1
			                ) {
			                  const sectionListRenderer = Util.getSingleObjectByKey(
			                    data,
			                    "sectionListRenderer",
			                  ...
			                  if (
			                    ...
			                    for (let i = itemContainer.length - 1; i >= 0; i--) {
			                      const items =
			                        itemContainer[i]?.["itemSectionRenderer"]?.[
			                          "contents"
			                        ] ||
			                      ...
			                      if (items?.constructor === Array && items.length > 0) {
			                        for (let j = items.length - 1; j >= 0; j--) {
			                          const browseId =
			                            ...
			                            items[j]?.["videoRenderer"]?.["ownerText"]?.[
			                              "runs"
			                          ...
			                          const shelfRendererId =
			                            shelfRenderer?.["endpoint"]?.["browseEndpoint"]?.[
			                              "browseId"
			                            ];
			                          ...
			                          if (iridiumSettings.blacklist[shelfRendererId]) {
			                            ...
			                            const shelfRendererContent =
			                              shelfRenderer?.["content"];
			                            const shelfItems =
			                              shelfRendererContent?.["verticalListRenderer"]?.[
			                                "items"
			                              ] ||
			              ...
			              const update = (data) => {
			                ...
			                items.forEach((item) => {
			                  const renderer =
			                    item?.["data"]?.["content"]?.["videoRenderer"] ||
			                    item?.["data"];
			                  const browseId =
			            ...
			            const FeatureBlacklistButton = (() => {
			                  ...
			                  menus.forEach((menu) => {
			                    ...
			                    if (items?.constructor === Array) {
			                      for (let i = items.length - 1; i >= 0; i--) {
			                        if (
			                          items[i]?.["menuServiceItemRenderer"]?.["id"] ===
			                          "blockChannel"
			                        ) {
			                          items.splice(i, 1);
			                        }
			                    ...
			                    if (backupItems?.constructor === Array) {
			                      for (let i = backupItems.length - 1; i >= 0; i--) {
			                        if (
			                          backupItems[i]?.["menuServiceItemRenderer"]?.[
			                            "id"
			                          ] === "blockChannel"
			                        ) {
			              ...
			              const onItemSelectedAction = (event) => {
			                const channelData =
			                  event.detail?.["args"]?.[0]?.["channelData"];
			              ...
			              const iniBlacklistButton = (event) => {
			                ...
			                if (
			                  ...
			                  "yt-menu-service-item-selected-action"
			                ) {
			              ...
			              const checkBlacklistButton = (data) => {
			                ...
			                const parent = Array.from(
			                  document.querySelectorAll(
			                    FeatureBlacklist.targetTags.join(","),
			                  ),
			                ...
			                if (!parent) {
			                  ...
			                  !items.some(
			                    (item) =>
			                      item?.["menuServiceItemRenderer"]?.["id"] ===
			                      "blockChannel",
			                  )
			                ) {
			                  const renderer =
			                    parent?.["data"]?.["content"]?.["videoRenderer"] ||
			                    parent?.["data"];
			                  const channelUC =
			                    renderer?.["shortBylineText"]?.["runs"]?.[0]?.[
			                      "navigationEndpoint"
			            ...
			            if (Object.keys(changeData).length > 0) {
			              ...
			              if (Object.hasOwn(changeData, SettingData.syncSettings.id)) {
			                if (changeData[SettingData.syncSettings.id] === true) {
			                  ...
			                  browser.storage.sync.onChanged.removeListener(
			                    onStorageChanged,
			                  );
